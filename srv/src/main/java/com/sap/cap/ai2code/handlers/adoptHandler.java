...
public class adoptHandler implements EventHandler {
    ...
    public void onAdopt(BotMessagesAdoptContext context) {
        ...
        // String cleanedPath = path.contains("SubContext:") ?
        // path.replaceFirst("SubContext:", "")
        // : path;
        ...
        // // Value: BotMessages.message/Convert to the corresponding format according
        // to
        // // the AI function call
        // String messageValue = processMessageValue(botMessage,
        // botType.getContextType());
        ...
        // CqnInsert insertContextNode =
        // Insert.into(ContextNodes_.CDS_NAME).entry(contextNode);
        ...
        // System.out.println("Successfully processed BotInstance ID: " +
        // botInstanceId);
        // } catch (Exception e) {
        ...
        // System.err.println("Failed to process BotMessage for BotInstance ID: " +
        // botInstanceId +
        // ". Error: " + e.getMessage());
        ...
        // } catch (Exception e) {
        // System.err.println("Error in adopt handler: " + e.getMessage());
        // throw new RuntimeException("Failed to adopt bot messages: " + e.getMessage(),
        // e);
        // }
    }
    // /**
